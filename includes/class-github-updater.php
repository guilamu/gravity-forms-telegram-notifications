...
/**
 * Class GF_Telegram_GitHub_Updater
 *
...
class GF_Telegram_GitHub_Updater
{
     ...
     * @var string
     */
    private const GITHUB_REPO = 'gravity-forms-telegram-notifications';
     ...
     * @var string
     */
    private const PLUGIN_FILE = 'gravity-forms-telegram-notifications/gravity-forms-telegram-notifications.php';
     ...
     * @var string
     */
    private const PLUGIN_SLUG = 'gravity-forms-telegram-notifications';
     ...
     * @var string
     */
    private const PLUGIN_NAME = 'Gravity Forms Telegram Notifications';
     ...
     * @var string
     */
    private const PLUGIN_DESCRIPTION = 'Sends a Telegram message to a chat, group, channel or forum topic when a Gravity Form is submitted.';
     ...
     * @var string
     */
    private const TEXT_DOMAIN = 'gravity-forms-telegram-notifications';
     ...
     * @var string
     */
    private const CACHE_KEY = 'gf_telegram_github_release';
    ...
    {
        if (defined('GF_TELEGRAM_BASENAME') && is_string(GF_TELEGRAM_BASENAME) && '' !== GF_TELEGRAM_BASENAME) {
            return GF_TELEGRAM_BASENAME;
        }
    ...
    private static function build_plugin_info_result(): stdClass
    {
        ...
        if (defined('GF_TELEGRAM_VERSION')) {
            $installed_version = GF_TELEGRAM_VERSION;
        } else {
    ...
    private static function build_fallback_plugin_info_result(): stdClass
    {
        ...
        $result->version      = defined('GF_TELEGRAM_VERSION') ? GF_TELEGRAM_VERSION : '1.0.0';
    ...
    public static function plugin_info_css(): void
    {
        ...
        if (defined('self::REQUIRES_GF')) {
            $requires_gf_html = sprintf(
                ...
                esc_html__('Requires Gravity Forms:', 'gravity-forms-telegram-notifications'),
                esc_html(sprintf(
                    /* translators: %s: The minimum required Gravity Forms version. */
                    __('%s or higher', 'gravity-forms-telegram-notifications'),
                    self::REQUIRES_GF
                ))
            );
    ...
    public static function fix_folder_name($source, $remote_source, $upgrader, $hook_extra)
    {
        ...
        return new WP_Error(
            'rename_failed',
            __('Unable to rename the update folder. Please retry or update manually.', 'gravity-forms-telegram-notifications')
        );
    }
}

// Initialize the updater
GF_Telegram_GitHub_Updater::init();
